...
def val_metrics(pred, logger):
    # pdb.set_trace()
    val_num_each = [1260, 1940, 2280, 1040, 500, 400, 3680, 1340,
                    460, 340, 300, 320, 320, 340, 280, 420,
                    140, 200, 120, 160, 200, 240, 120, 140, 140, 120]
    test_num_each = [5464, 5373, 207014, 4239, 3936, 6258, 10474, 6273,
...
def main():
    ...
    # val_data = SurgVisDom(config.data.val_list, config.data.label_list, num_segments=config.data.num_segments,
